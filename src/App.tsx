...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<'home' | 'loans' | 'insurance' | 'forex' | 'travel' | 'about' | 'contact'>('home');
  ...
  const handleTabChange = (tabName: 'home' | 'loans' | 'insurance' | 'forex' | 'travel' | 'about' | 'contact') => {
  ...
  const selectServiceAndScroll = (serviceKey: string) => {
    ...
    } else if (serviceKey === 'insurance') {
      handleTabChange('insurance');
    } else if (serviceKey === 'forex') {
      handleTabChange('forex');
    } else if (serviceKey === 'travel') {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center flex-shrink-0">
              <button onClick={() => handleTabChange('home')} className="flex items-center gap-3 group text-left focus:outline-none cursor-pointer">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              <div className="flex space-x-7">
                {[
                  { id: 'home', name: "Home", onClick: () => handleTabChange('home') },
                  { id: 'loans', name: "Loans", onClick: () => handleTabChange('loans') },
                  { id: 'insurance', name: "Insurance", onClick: () => handleTabChange('insurance') },
                  { id: 'forex', name: "Forex", onClick: () => handleTabChange('forex') },
                  { id: 'travel', name: "Travel", onClick: () => handleTabChange('travel') },
                  { id: 'about', name: "About Us", onClick: () => handleTabChange('about') },
                  { id: 'contact', name: "Contact Us", onClick: () => handleTabChange('contact') }
                ].map((item, idx) => (
                  <button
                    key={idx}
                    onClick={item.onClick}
                    className={`text-sm font-medium hover:text-brand-gold cursor-pointer transition-colors relative py-1 ${
                      activeTab === item.id ? "text-brand-gold after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-brand-gold" : "text-gray-200"
                    }`}
                  >
                    {item.name}
                  </button>
              ...
              <button 
                ...
                className="bg-brand-gold hover:bg-yellow-400 text-brand-blue font-semibold py-2.5 px-6 rounded transition-all duration-300 transform active:scale-95 shadow-md shadow-brand-gold/10 text-sm cursor-pointer"
              >
          ...
          <div className="lg:hidden bg-brand-blue border-t border-gray-800 absolute w-full left-0 shadow-xl">
            <div className="px-4 pt-3 pb-6 space-y-4">
              <div className="space-y-2">
                {[
                  ...
                  <button
                    key={idx}
                    onClick={item.onClick}
                    className={`block w-full text-left px-3 py-2.5 rounded-md text-base font-medium hover:bg-blue-950 transition-all ${
                      activeTab === item.id ? "bg-blue-950 text-brand-gold font-bold animate-pulse" : "hover:text-brand-gold text-white"
                    }`}
                  >
                    {item.name}
                  </button>
              ...
              <div className="pt-4 border-t border-gray-800 space-y-3">
                <button 
                  onClick={() => handleTabChange('contact')}
                  className="w-full bg-brand-gold hover:bg-yellow-400 text-brand-blue font-semibold py-3 px-4 rounded transition-colors text-center shadow-lg text-sm cursor-pointer"
                >
                  Get Free Consultation
                </button>
              </div>
      ...
      <main className="flex-grow">
            ...
            <section id="contact" className="py-20 bg-white relative">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white rounded-2xl shadow-[0_15px_45px_rgba(0,0,0,0.08)] border border-gray-100 overflow-hidden flex flex-col lg:flex-row relative">
                  ...
                  {/* Left Column banner */}
                  <div className="p-10 lg:p-14 lg:w-2/5 flex flex-col justify-center relative bg-brand-blue text-white overflow-hidden text-left">
                  ...
                  <div className="p-10 lg:p-14 lg:w-3/5 bg-gray-50 flex flex-col justify-center relative">
                    {formSubmitted ? (
                      ...
                      <form onSubmit={handleLeadSubmit} className="w-full space-y-5 relative z-10 text-left">
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((test) => (
                      <div 
                        key={test.id} 
                        className="bg-white p-8 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group text-left"
                      >
        ...
        {activeTab === 'loans' && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <LoansTab onApplyClick={(type) => {
              setLoanForm(prev => ({ ...prev, loanType: type }));
              setLoanSubmitted(false);
              setIsApplyModalOpen(true);
            }} />
          </div>
        ...
        {activeTab === 'insurance' && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <InsuranceTab onQuoteClick={(srvType) => {
              setLeadForm(prev => ({ ...prev, service: srvType }));
              handleTabChange('contact');
            }} />
          </div>
        )}
        ...
        {activeTab === 'forex' && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <ForexTab onForexRequest={(reqDetails) => {
              setLeadForm(prev => ({ ...prev, service: 'forex', city: reqDetails }));
              handleTabChange('contact');
            }} />
          </div>
        )}
        ...
        {activeTab === 'travel' && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <TravelTab onTravelEnquiry={(enqDetails) => {
              setLeadForm(prev => ({ ...prev, service: 'travel', city: enqDetails }));
              handleTabChange('contact');
            }} />
          </div>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  { name: "Home", onClick: () => handleTabChange('home') },
                  { name: "Loans", onClick: () => handleTabChange('loans') },
                  { name: "Insurance", onClick: () => handleTabChange('insurance') },
                  { name: "Forex", onClick: () => handleTabChange('forex') },
                  { name: "Tour & Travel", onClick: () => handleTabChange('travel') },
                  { name: "About Us", onClick: () => handleTabChange('about') },
                  { name: "Contact Us", onClick: () => handleTabChange('contact') }
                ].map((link, idx) => (
                  <li key={idx}>
                    <button 
